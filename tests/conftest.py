...
SAMPLE_METADATA = Metadata(
    ...
    variable_groups=[
        ...
        VariableGroup(id="Drought", name="Drought", children=["consecutive_dry_days"]),
        VariableGroup(id="Heat", name="Heat", children=["TXx"]),
        VariableGroup(id="Extreme Precipitation", name="Extreme Precipitation", children=["rx1day"]),
        VariableGroup(id="Fire", name="Fire", children=["fwils"]),
        VariableGroup(id="Freshwater", name="Freshwater", children=["dis"]),
        VariableGroup(id="Agriculture", name="Agriculture", children=["maize_yield"]),
        VariableGroup(id="Labour Productivity", name="Labour Productivity", children=["labour-productivity-loss"]),
    ],
    vars=[
        Variable(
            id="tasAdjust",
        ...
        Variable(
            ...
            unit="days",
            description="Max number of consecutive dry days",
            group="Drought",
            spatial_weighting=[],
        ),
        Variable(
        ...
        Variable(
            ...
            unit="days",
            description="Fire weather index - likelihood of spread",
            group="Fire",
            spatial_weighting=[],
        ),
        Variable(
        ...
        Variable(
            ...
            name="Maize Yield",
            unit="%",
            description="Maize yield change",
            group="Agriculture",
            spatial_weighting=[],
        ),
        Variable(
            id="labour-productivity-loss",
            name="Labour Productivity Loss",
            unit="%",
            description="Labour productivity loss due to heat",
